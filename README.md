...
*  **Architecture**: Implementing the **Page Object Pattern (POP)** for scalable and maintainable code.
*  **Performance Testing**: Basic concepts of measuring application speed and stability.
*  **CI/CD Integration**: Understanding automated workflows and version control with **GitHub**.
*  **Behavior Driven Development (BDD)**: Writing test scenarios in **Gherkin** for better business-tech alignment.
...
* **Gherkin** (Business Readable DSL for Testing)
